...
export default {
  ...
  async asyncData(ctx) {
    ...
    const rawData = await axios.get(`http://localhost:3000/api/populars?q=${yearSSR}`)
    // const rawData = await axios.get(`https://kdramalike.com/api/populars?q=${yearSSR}`)
    .catch(err => {
