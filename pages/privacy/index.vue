    ...
    <div class="container mx-auto py-10">
      ...
      <div>
        ...
        <p>
          ...
          accessible at kdramalike.com unless otherwise defined in this Privacy Policy.
        </p>
      </div>
        <h2 class="pt-10 text-xl font-semibold">Information Collection and Use</h2>
      <p>
        ...
        <h2 class="pt-10 text-xl font-semibold ">Log Data</h2>
      <p>We want to inform you that whenever you use our Service, in a case of an error in the
        app we collect data
        ...
        <h2 class="pt-10 text-xl font-semibold ">Cookies</h2>
      <p>This Service does not use these “cookies” explicitly. However, the app may use
        ...
        <h2 class="pt-10 text-xl font-semibold ">Service Providers</h2>
      ...
      <p>To facilitate our Service;
        ...
        <h2 class="pt-10 text-xl font-semibold ">Security</h2>
      ...
      <p>We value your trust in providing us your Personal Information, thus we are striving to
        ...
        <h2 class="pt-10 text-xl font-semibold">Links to Other Sites</h2>
      <p>This Service may contain links to other sites. If you click on a third-party link, you
        ...
        <h2 class="pt-10 text-xl font-semibold">Children’s Privacy</h2>
      <p>We do not knowingly collect personally identifiable information from children. We
        ...
        this Policy by instructing their children never to provide personally identifiable information through
        the Application and/or Services without their permission. If you have reason to believe that a child has
        provided personally identifiable information to us through the Application and/or Services, please
        contact us. You must also be at least 16 years of age to consent to the processing of your personally
        identifiable information in your country (in some countries we may allow your parent or guardian to do
        so on your behalf).
      </p>


        <h2 class="pt-10 text-xl font-semibold">Changes to This Privacy Policy</h2>

      <p>
        We may update our Privacy Policy from time to time. Thus, you are advised to review this page
        periodically for any changes. We will notify you of any changes by posting the new Privacy Policy on
        this page. <strong>This policy is effective as of 2021-12-24</strong>
      ...
      <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to
        contact us at
        <strong>contact@kdramalike.com</strong>
      </p>
