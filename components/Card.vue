<template>
  <div>
    <div v-show="!isImageLoaded" class="lg:w-[180px] lg:h-[253px] w-[103px] h-[145px] bg-[#dbdbdb] rounded-xl relative">
    ...
    <div v-show="isImageLoaded"
         class="custom-card cursor-pointer lg:w-[180px] w-[103px] outline outline-[1px] outline-[#dbdbdb] rounded-xl relative overflow-hidden">
      ...
      <div v-if="renderRate" class="absolute top-1 right-1 z-10 hidden">
        ...
        <svg id="svgProgress" height="0" width="0" viewBox="0 0 100 100"
          ...
          <circle
              ...
              :stroke-dashoffset="2*Math.PI*40 - (2*Math.PI*45*(parseInt(renderRate)/100))"
              transform="rotate(-90 50 50)"/>
      ...
      <img @load="imageLoadStatus" :src="'/img/' + idProp + '.webp'" class="card-image object-fill w-full rounded-xl lg:w-[180px] lg:h-[253px] w-[103px] h-[145px]" alt="">
